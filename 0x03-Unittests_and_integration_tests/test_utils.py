...
class TestAccessNestedMap(unittest.TestCase):
    ...
    def test_access_nested_map(self, nested_map, path, expected_result):
        ...
        The function should retrieve values from
        a nested map based on the provided path.
        """
    ...
    def test_access_nested_map_exception(self, nested_map, path):
        ...
        Parameters:
        - nested_map (dict): The nested dictionary to traverse.
        - path (tuple): The path to
        a key that does not exist in the nested_map.

        The function should raise a KeyError when
...
class TestGetJson(unittest.TestCase):
    ...
    def test_get_json(self, test_url, test_payload, mock_get_json):
        ...
        - test_payload (dict): The expected payload
          returned by the mocked HTTP call.
...
class TestMemoize(unittest.TestCase):
    ...
    def test_memoize(self):
        ...
        The test class TestClass has
        a memoized property (a_property) that calls
